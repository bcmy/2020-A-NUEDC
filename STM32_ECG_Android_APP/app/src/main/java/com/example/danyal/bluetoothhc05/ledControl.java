        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                if(receive_text_data.startsWith("add 1,0,")){
                    pathView.setData((Integer.parseInt(receive_text_data.substring(8)) - 260/2 )*3);
                ...
                else if(receive_text_data.startsWith("t5.txt=")) {
                    text3.setText("心率:");
                    text3.append((receive_text_data.substring(8).split("\"")[0]));
                    text3.append("bpm");
                }
                else if(receive_text_data.startsWith("t8.txt=")) {
                    text4.setText("步数:");
                    text4.append((receive_text_data.substring(8).split("\"")[0]));
                    text4.append("");
                }
                else if(receive_text_data.startsWith("t9.txt=")) {
                    text5.setText("路程:");
                    text5.append((receive_text_data.substring(8).split("\"")[0]));
                    text5.append("m");
                }
                    else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                sendSignal(text1.getText().toString());
        ...
        seekBar2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                pathView.offset_num  = (progress*80);
              Log.i("progress","f"+progress);
